...
class ProgramController extends Controller
{
        ...
        return Inertia::render('Program/Index', [
            'programs' => $programs
                ->map(fn (Program $program) => [
                    ...
                    'is_mesyuarat' => $program->is_mesyuarat,
            ...
            'selectedProgram' => $selectedProgram
                ? [
                    ...
                    'is_mesyuarat' => $selectedProgram->is_mesyuarat,
    ...
    public function mesyuarat(Request $request, Program $program): JsonResponse
    {
        ...
        $this->ensureAccessible($userId, $program);
        ...
        $attendees = $program->attendees()
            ...
            ->map(fn (ProgramAttendee $attendee) => [
                'id' => $attendee->id,
                'nama' => $attendee->voter?->nama ?? 'Nama tidak dijumpai',
                'no_ic' => $attendee->voter?->no_ic ?? '',
                'voter_id' => $attendee->voter_id,
                'is_mesyuarat' => $attendee->is_mesyuarat,
                'marked' => $attendee->marked,
                'sub_programs' => $attendee->subPrograms->map(fn ($sp) => [
                    'id' => $sp->id,
                    'name' => $sp->name,
                ]),
            ]);
