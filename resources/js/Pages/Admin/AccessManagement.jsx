        ...
        <div className="rounded-lg border border-slate-200 bg-white px-3 py-3 shadow-sm">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                    {user.can_impersonate && <button onClick={imp} className="inline-flex items-center gap-1.5 rounded-md border border-amber-300 bg-white px-3 py-1.5 text-xs font-bold text-amber-600 transition hover:bg-amber-50"><Icon name="login" className="h-3.5 w-3.5" />Masuk Sebagai</button>}
