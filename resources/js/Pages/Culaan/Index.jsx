                            ...
                            <div id="senarai-grid" className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                                {rows.map((voter, index) => (
                                    <div
                                        ...
                                        className={`rounded-xl border bg-white p-3 shadow-sm overflow-hidden cursor-pointer transition-all duration-300 ease-in-out hover:shadow-md hover:scale-[1.02] ${voter.id === selectedVoterId ? 'border-2 border-slate-800 shadow-slate-800/20 scale-[1.02]' : 'border-green-600 shadow-green-600/20'}`}
                                    >
