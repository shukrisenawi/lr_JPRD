    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-7xl space-y-3 px-3 sm:px-4 lg:px-6">
                {pemilih_report?.name && (
                    <div className="inline-flex items-center rounded-md border border-green-200 bg-green-50 p-1.5 shadow-sm" title={`Fail: ${pemilih_report.name}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-700" aria-hidden="true">
