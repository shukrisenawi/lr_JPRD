                                    ...
                                    <tr key={voter.id} className="border-b border-slate-100 transition hover:bg-green-50/50">
                                        <td className="px-3 py-2.5">
                                            <div className="flex items-center gap-2">
                                                {voter.avatar_url ? (
                                                    <img src={voter.avatar_url} alt="" className="h-6 w-6 shrink-0 rounded-full object-cover border border-slate-200" />
                                                ) : null}
                                        ...
                                        <td className="px-3 py-2.5">
                                            <div className="flex items-center gap-1">
                                                <input ref={(el) => { avatarInputRefs.current[voter.id] = el; }} type="file" accept="image/png,image/jpeg,image/jpg,image/webp" onChange={(e) => handleAvatarUpload(voter, e)} className="hidden" />
