            ...
            <section className="card relative">
                <div className="px-4 py-3">
                    ...
                    <div className="relative mt-2">
                        ...
                        <input type="search" value={q} onChange={handleChange} onFocus={(e) => e.target.select()} placeholder="Ali, 900101-01-1234, 0123456789" className="input-field py-2 pl-10 pr-10 focus:ring-2" />
                        {q ? (
                            <button
                                type="button"
                                onClick={clearSearch}
